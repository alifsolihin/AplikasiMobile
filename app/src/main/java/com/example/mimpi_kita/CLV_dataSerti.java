...
public class CLV_dataSerti extends ArrayAdapter<String> {
    ...
    public CLV_dataSerti(Activity context, ArrayList<String> nama_serti, ArrayList<String> nama_user,ArrayList<String> nama_owner, ArrayList<String> gambar_serti)
    {
        super(context, R.layout.grid_list,nama_serti);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.grid_list, null, true);
