...
public class EditUser extends AppCompatActivity {
    ...
    TextInputEditText ETuser, ETnama, ETcall, ETalamat, ETlhr, ETpass;
    Spinner SPlvl;

    String s_email,s_nama,s_call,s_alamat,s_date,s_pass,s_lvl,s_foto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTNedit = findViewById(R.id.BTNeditUS);
        BTNhapus = findViewById(R.id.BTNhapusUS);
        ETuser = findViewById(R.id.ETUserUS);
        ETnama = findViewById(R.id.ETNamaUS);
        ETcall = findViewById(R.id.ETCallUS);
        ETalamat = findViewById(R.id.ETAlamatUS);
        ETlhr = findViewById(R.id.ETTanggalLahirUS);
        BTNImageEv    = findViewById(R.id.IBGambarEV);
        ETpass = findViewById(R.id.ETPassUS);
        ...
        s_nama = getIntent().getStringExtra("nama");
        s_call = getIntent().getStringExtra("no_hp");
        s_alamat = getIntent().getStringExtra("alamat");
        s_date = getIntent().getStringExtra("tanggal_lahir");
        s_pass = getIntent().getStringExtra("password");
        s_lvl = getIntent().getStringExtra("level");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent Back;
                Back = new Intent(EditUser.this,PengolahanUser.class);
                startActivity(Back);
                finish();
            }
        ...
        ETlhr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(EditUser.this,
        ...
        BTNImageEv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EditUser.this);
        ...
        BTNhapus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(EditUser.this)
                        .setTitle("Peringatan ⚠")
                        .setMessage("Apakah Anda ingin menghapus user dengan nama: " + s_nama + " ?")
                        .setCancelable(false)
                        .setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                AndroidNetworking.post("https://tkjbpnup.com/kelompok_9/mimpikita/hapusDataUser.php")
                                        .addBodyParameter("email", "" + s_email)
                                                    ...
                                                    if (status) {
                                                        new AlertDialog.Builder(EditUser.this)
                                                                ...
                                                                .setPositiveButton("kembali", new DialogInterface.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        Intent i = new Intent(EditUser.this, PengolahanUser.class);
                                                                        startActivity(i);
                                                        ...
                                                        Toast.makeText(EditUser.this, "" + result, Toast.LENGTH_SHORT).show();
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                }
        ...
        BTNedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(EditUser.this)
                        .setTitle("Peringatan ⚠")
                        .setMessage("Apakah Anda ingin mengupdate user dengan nama: " + s_nama + " ?")
                        .setCancelable(false)
                        .setPositiveButton("Iya", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                s_email        = ETuser.getText().toString();
                                s_nama        = ETnama.getText().toString();
                                s_call        = ETcall.getText().toString();
                                s_alamat      = ETalamat.getText().toString();
                                s_pass        = ETpass.getText().toString();
                                s_date        = ETlhr.getText().toString();
                                s_lvl          = SPlvl.getSelectedItem().toString();
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(EditUser.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(EditUser.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(EditUser.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void validasiData(){
        if(s_email.equals("")){
            progressDialog.dismiss();
            Toast.makeText(EditUser.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            updateData();
        }
    }
    ...
    void updateData(){
        ...
        AndroidNetworking.post("https://tkjbpnup.com/kelompok_9/mimpikita/editDataUser.php")
                .addBodyParameter("nama",""+s_nama)
                .addBodyParameter("email",""+s_email)
                .addBodyParameter("no_hp",""+s_call)
                .addBodyParameter("alamat",""+s_alamat)
                .addBodyParameter("tanggal_lahir",""+s_date)
                .addBodyParameter("password",""+s_pass)
                .addBodyParameter("level",""+s_lvl)
                            ...
                            if(status){
                                new AlertDialog.Builder(EditUser.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(EditUser.this,PengolahanUser.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
