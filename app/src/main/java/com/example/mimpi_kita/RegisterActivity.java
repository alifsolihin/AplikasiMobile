...
public class RegisterActivity extends AppCompatActivity {
    ...
    String s_email,s_nama,s_call,s_alamat,s_date,s_pass;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = findViewById(R.id.idETtgllahir);
        email = findViewById(R.id.idETemail);
        nama = findViewById(R.id.idETnama);
        call = findViewById(R.id.idETcall);
        alamat = findViewById(R.id.idETalamat);
        pass = findViewById(R.id.idETpass);
        BTNadd = findViewById(R.id.idBTNdft);
        spinner = findViewById(R.id.idSPlv);
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(RegisterActivity.this, authorities, photoFile);
    ...
    void validasiData(){
        if(email.equals("") && nama.equals("") && call.equals("") && alamat.equals("") && pass.equals("") && date.equals("")){
            progressDialog.dismiss();
                            ...
                            if(status){
                                new AlertDialog.Builder(RegisterActivity.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(RegisterActivity.this,MainActivity.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
