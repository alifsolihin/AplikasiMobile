...
public class CLV_dataorderadmin extends ArrayAdapter<String> {
    ...
    public CLV_dataorderadmin(Activity context, ArrayList<String> nama_ev, ArrayList<String> lokasi_ev, ArrayList<String> jadwal_ev, ArrayList<String> mulai_ev,
        ...
        super(context, R.layout.list_item_order_admin, nama_ev);
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            View rowView= inflater.inflate(R.layout.list_item_order_admin, null, true);

            //Declarasi komponen
            TextView namaps_ev       = rowView.findViewById(R.id.idTXTNama);
            ...
            namaps_ev.setText(vnamaps_ev.get(position));
