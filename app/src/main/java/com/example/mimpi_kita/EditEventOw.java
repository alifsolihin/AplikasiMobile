...
public class EditEventOw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_event_ow);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent Back;
                Back = new Intent(EditEventOw.this,PengolahanEventOwner.class);
                startActivity(Back);
                finish();
            }
        ...
        BTNnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent page;
                page = new Intent(EditEventOw.this,EditEvent2Ow.class);
