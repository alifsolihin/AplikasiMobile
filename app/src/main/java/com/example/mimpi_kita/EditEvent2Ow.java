...
public class EditEvent2Ow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_event2_ow);
        ...
        BTNImageEv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(EditEvent2Ow.this);
    ...
    public  void TakePhoto(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditEvent2Ow.this);
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(EditEvent2Ow.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(EditEvent2Ow.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(EditEvent2Ow.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void getDataIntent(){
        ...
        BTNeditEV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                namaEv = getIntent().getStringExtra("nama_ev");
                tglev = getIntent().getStringExtra("tanggal_ev");
                new AlertDialog.Builder(EditEvent2Ow.this)
                        .setTitle("Peringatan ⚠")
                                                    ...
                                                    if (status) {
                                                        new AlertDialog.Builder(EditEvent2Ow.this)
                                                                ...
                                                                .setPositiveButton("kembali", new DialogInterface.OnClickListener() {
                                                                    @Override
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        Intent i = new Intent(EditEvent2Ow.this, PengolahanEventOwner.class);
                                                                        startActivity(i);
                                                                        EditEvent2Ow.this.finish();
                                                                    }
                                                                })
                                                                .show();

                                                    } else {
                                                        Toast.makeText(EditEvent2Ow.this, "" + result, Toast.LENGTH_SHORT).show();
                                                    }
                                                } catch (Exception e) {
                                                    e.printStackTrace();
                                                }
    ...
    void validasiData(){
        if(benefit1Ev.equals("")){
            progressDialog.dismiss();
            Toast.makeText(EditEvent2Ow.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            updateData();
        }
    }
                            ...
                            if(status){
                                new AlertDialog.Builder(EditEvent2Ow.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(EditEvent2Ow.this,PengolahanEventOwner.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
