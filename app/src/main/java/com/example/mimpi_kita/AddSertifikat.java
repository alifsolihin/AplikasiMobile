...
public class AddSertifikat extends AppCompatActivity {

    TextInputEditText EtnamaEV,ETnamawin, ETowner;
    ProgressDialog progressDialog;
    private Context mContext;
    Button BTNsaveData;
    String s_namaev, s_namawin, s_owner, nama;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent Back;
                Back = new Intent(AddSertifikat.this,PengolahanSertifikatOw.class);
                startActivity(Back);
                finish();
            }
        ...
        BTNImageEv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AddSertifikat.this);
        ...
        BTNsaveData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap == null){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(AddSertifikat.this);
    ...
    void validasiData(){
        if(ETnamawin.equals("")){
            progressDialog.dismiss();
            Toast.makeText(AddSertifikat.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            kirimData();
        }
    }
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(AddSertifikat.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(AddSertifikat.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(AddSertifikat.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void kirimData(){
        ...
        AndroidNetworking.post("https://tkjbpnup.com/kelompok_9/mimpikita/addDataSerti.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(AddSertifikat.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(AddSertifikat.this)
                                        .setMessage("Berhasil Menambahkan Data !")
                                        .setCancelable(false)
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                nama = getIntent().getStringExtra("nama_owner");
                                                Intent page;
                                                page = new Intent(AddSertifikat.this,PengolahanSertifikatOw.class);
                                                page.putExtra("nama_owner", nama);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
