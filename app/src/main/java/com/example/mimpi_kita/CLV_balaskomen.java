...
public class CLV_balaskomen extends ArrayAdapter<String> {
    ...
    private ArrayList<String> vbalas_km;

    public CLV_balaskomen(Activity context, ArrayList<String> nama_ev, ArrayList<String> namaps_ev, ArrayList<String> owner_ev,
                         ArrayList<String> komen_ev, ArrayList<String> waktu_km, ArrayList<String> balas_km)
    {
        super(context, R.layout.list_balas_komen,nama_ev);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.list_balas_komen, null, true);
        ...
        TextView balas_ev     = rowView.findViewById(R.id.idTXTbalas);
        ...
        balas_ev.setText(vbalas_km.get(position));
