...
public class AddEvent2 extends AppCompatActivity {
    ...
    String namaEv, tglrgEV, lokasiEV, jadwalEV, mulaiEV, akhirEV, ownerEV, deskripsiEV, benefit1Ev, benefit2Ev, hargaEv, tiketEv, jenisEv;
        ...
        BTNImageEv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AddEvent2.this);
        ...
        BTNsaveData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitMap == null){
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(AddEvent2.this);
    ...
    void validasiData(){
        if(benefit1Ev.equals("")){
            progressDialog.dismiss();
            Toast.makeText(AddEvent2.this, "Periksa kembali data yang anda masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            kirimData();
        }
    }
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(AddEvent2.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(AddEvent2.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(AddEvent2.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(AddEvent2.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(AddEvent2.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(AddEvent2.this,PengolahanEvent.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
