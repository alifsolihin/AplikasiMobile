...
public class PengolahanEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengolahan_event);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent Back;
                Back = new Intent(PengolahanEvent.this,AdminDashboard.class);
                startActivity(Back);
                finish();
            }
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try{
                            ...
                            if(status){
                                ...
                                final CLV_dataevent2 adapter = new CLV_dataevent2(PengolahanEvent.this,array_nama_ev,array_tanggal_ev,array_lokasi_ev,array_jadwal_ev,array_mulai_ev,
...
//edit and delete
                                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Toast.makeText(PengolahanEvent.this, array_nama_ev.get(position), Toast.LENGTH_SHORT).show();
                                        ...
                                        Intent i = new Intent(PengolahanEvent.this, EditEvent.class);
                                ...
                                Toast.makeText(PengolahanEvent.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.action_add){
            Intent i = new Intent(PengolahanEvent.this,AddEvent.class);
