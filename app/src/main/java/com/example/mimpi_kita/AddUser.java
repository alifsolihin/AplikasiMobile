...
public class AddUser extends AppCompatActivity {
    ...
    String s_email,s_nama,s_call,s_alamat,s_date,s_pass,s_lvl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent Back;
                Back = new Intent(AddUser.this,PengolahanUser.class);
                startActivity(Back);
                finish();
            }
    ...
    void validasiData(){
        if(ETuser.equals("")){
            progressDialog.dismiss();
            Toast.makeText(AddUser.this, "Periksa Kembali Data Yang Anda Masukkan !", Toast.LENGTH_SHORT).show();
        }else {
            kirimData();
        }
    }
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo"))
                {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(AddUser.this, authorities, photoFile);
                ...
                else
                {
                    ...
                    ActivityCompat.requestPermissions(AddUser.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, CODE_GALLERY_REQUEST);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(AddUser.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
        } else {
            if (intent != null) {
    ...
    void kirimData(){
        ...
        AndroidNetworking.post("https://tkjbpnup.com/kelompok_9/mimpikita/addDataUser.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(AddUser.this, ""+pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            if(status){
                                new AlertDialog.Builder(AddUser.this)
                                        ...
                                        .setPositiveButton("Kembali", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent page;
                                                page = new Intent(AddUser.this,PengolahanUser.class);
                                                startActivity(page);
                                            }
                                        })
                                        .show();
